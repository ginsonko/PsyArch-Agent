...
export const api = {
  ...
  agentPersonaHistory: () => apiGet<any>('/api/agent/persona-history', 20000),
  agentSavePersonaHistory: (payload: Record<string, unknown>) => apiPost<any>('/api/agent/persona-history/save', payload, 30000),
  agentApplyPersonaHistory: (id: string) => apiPost<any>('/api/agent/persona-history/apply', { id }, 30000),
  agentDeletePersonaHistory: (id: string) => apiPost<any>('/api/agent/persona-history/delete', { id }, 30000),
  agentUserProgress: () => apiGet<any>('/api/agent/user-progress', 20000),
  agentUpdateUserProgressLoadout: (payload: Record<string, unknown>) => apiPost<any>('/api/agent/user-progress/loadout', payload, 30000),
  ...
  agentDiary: (detail = false) => apiGet<any>(`/api/agent/diary?detail=${detail ? '1' : '0'}&limit=100`, 20000),
  agentDiaryEntry: (id: string) => apiGet<any>(`/api/agent/diary?id=${encodeURIComponent(id)}&detail=1`, 20000),
  agentSaveDiary: (payload: Record<string, unknown>) => apiPost<any>('/api/agent/diary/save', payload, 30000),
  agentDeleteDiary: (id: string) => apiPost<any>('/api/agent/diary/delete', { id }, 30000),
  agentScheduledTasks: (includeInactive = true, detail = false) =>
    apiGet<any>(`/api/agent/scheduled-tasks?include_inactive=${includeInactive ? '1' : '0'}&detail=${detail ? '1' : '0'}`, 20000),
